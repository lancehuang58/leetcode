...
class RemoveDuplicateNumbersFromSortedArrayTest {

  RemoveDuplicateNumbersFromSortedArray processor = new RemoveDuplicateNumbersFromSortedArray();
  ...
  void given_array_when_find_max_number_location_then_return_2() {
    int r = processor.execute(new int[] { 1, 2 });
  ...
  void given_array_6_when_find_max_location_the_return_3() {
    Assertions.assertThat(processor.execute(new int[] { 1, 1, 2, 2, 3, 3 })).isEqualTo(3);
  }
}
